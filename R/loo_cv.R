...
#' block version of R&W eq. 5.12. For site k with observation block B_k:
#'   mu_LOO  = y_{B_k} - [V^{-1}]_{B_k,B_k}^{-1} alpha_{B_k}
#'   Sigma_LOO = [V^{-1}]_{B_k,B_k}^{-1}
#' where V = Sigma + W_tap + nugget*I, alpha = V^{-1}(y - mu).
#'
