...
#'   \item{p}{6}
#'   \item{raw_df}{Data frame (5503 rows) with lon, lat, location, year,
#'     max_sea_level, data_source. The long-format source data, needed by
#'     \code{\link{fit_gev_detrended}} and \code{\link{bootstrap_W_detrended}}
...
#'
#' A set of 948 prediction locations along the U.S. East and Gulf Coast
#' at approximately 15 km spacing, used for kriging predictions.
#'
#' @format A data frame with 948 rows and 2 columns:
#' \describe{
#'   \item{lon}{Longitude in decimal degrees (range: -97.7 to -67.0).}
#'   \item{lat}{Latitude in decimal degrees (range: 25.0 to 45.1).}
#' }
#' @source Sampled from Natural Earth 1:50m coastline (see White et al.).
"prediction_grid"
