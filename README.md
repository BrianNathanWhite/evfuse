...
Rscript scripts/simulation_study.R     # Parameter recovery (§4.6.4) + RL recovery extension
Rscript scripts/shared_years_bootstrap.R # Cross-source W robustness check (not reported in the paper)
